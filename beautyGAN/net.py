...
#         layers_branch.append(nn.LeakyReLU(inplace=True))
...
#         layers_1.append(nn.LeakyReLU(inplace=True))
#         layers_1.append(nn.Conv2d(curr_dim, curr_dim, kernel_size=3, stride=1, padding=1, bias=False))
#         layers_1.append(nn.InstanceNorm2d(curr_dim, affine=True))
#         layers_1.append(nn.LeakyReLU(inplace=True))
#         layers_1.append(nn.Conv2d(curr_dim, 3, kernel_size=7, stride=1, padding=3, bias=False))
...
#         layers_2.append(nn.LeakyReLU(inplace=True))
#         layers_2.append(nn.Conv2d(curr_dim, curr_dim, kernel_size=3, stride=1, padding=1, bias=False))
#         layers_2.append(nn.InstanceNorm2d(curr_dim, affine=True))
#         layers_2.append(nn.LeakyReLU(inplace=True))
#         layers_2.append(nn.Conv2d(curr_dim, 3, kernel_size=7, stride=1, padding=3, bias=False))
...
#         out = {}
#         out['r11'] = F.leaky_relu(self.conv1_1(x))
#         out['r12'] = F.leaky_relu(self.conv1_2(out['r11']))
#         out['p1'] = self.pool1(out['r12'])
#         out['r21'] = F.leaky_relu(self.conv2_1(out['p1']))
#         out['r22'] = F.leaky_relu(self.conv2_2(out['r21']))
#         out['p2'] = self.pool2(out['r22'])
#         out['r31'] = F.leaky_relu(self.conv3_1(out['p2']))
#         out['r32'] = F.leaky_relu(self.conv3_2(out['r31']))
#         out['r33'] = F.leaky_relu(self.conv3_3(out['r32']))
#         out['r34'] = F.leaky_relu(self.conv3_4(out['r33']))
#         out['p3'] = self.pool3(out['r34'])
#         out['r41'] = F.leaky_relu(self.conv4_1(out['p3']))
        
#         out['r42'] = F.leaky_relu(self.conv4_2(out['r41']))
#         out['r43'] = F.leaky_relu(self.conv4_3(out['r42']))
#         out['r44'] = F.leaky_relu(self.conv4_4(out['r43']))
#         out['p4'] = self.pool4(out['r44'])
#         out['r51'] = F.leaky_relu(self.conv5_1(out['p4']))
#         out['r52'] = F.leaky_relu(self.conv5_2(out['r51']))
#         out['r53'] = F.leaky_relu(self.conv5_3(out['r52']))
#         out['r54'] = F.leaky_relu(self.conv5_4(out['r53']))
